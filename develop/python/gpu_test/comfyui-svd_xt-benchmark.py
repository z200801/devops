...
class TextToVideoBenchmark:
    ...
    def run_benchmark(self, iterations=5, output_file="text2video_benchmark.json"):
...
def main():
    parser = argparse.ArgumentParser(
        ...
        usage='%(prog)s SERVER:PORT [OPTIONS]\n\nExamples:\n'
              ...
              '  %(prog)s 127.0.0.1:8188 --iterations 10\n'
              '  %(prog)s localhost:8188 --frames 14 --steps 15',
    ...
    if len(sys.argv) == 1:
        ...
        print("  python text2video_benchmark.py 127.0.0.1:8188 --iterations 10")
        print("\nQuick test (fewer frames and steps):")
        print("  python text2video_benchmark.py localhost:8188 --frames 14 --steps 15 --iterations 3")
        print("\nHigh quality:")
        print("  python text2video_benchmark.py localhost:8188 --steps 30 --motion-bucket-id 150")
        print("\nCustom output file:")
        print("  python text2video_benchmark.py localhost:8188 --output h100_results.json")
        print("\nList available checkpoints:")
        print("  python text2video_benchmark.py localhost:8188 --list")
        print()
        sys.exit(0)
